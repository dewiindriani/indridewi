      ...
      <div class="content">
          ...
          <form action="input_pemesanan" method="post" enctype="multipart/form-data" id="form1">
            <table width="514" border="0">
              <tr>
                ...
                <td>:</td>
                <td><label>
                  <input type="text" name="id_book" id="id_book" />
                </label></td>
              </tr>
              <tr>
                <td>Nama Lengkap</td>
		...
		?>
              ...
              <tr>
                ...
                <td>:</td>
                <td><label>
                  <input name="jumlah_pemesanan" type="text" class="field" id="jumlah_pemesanan" value="" />
                </label></td>
              </tr>
              <tr>
                ...
                <td>:</td>
                <td><label>
                  <input type="text" name="tot_bayar" id="tot_bayar" />
                </label></td>
              </tr>
              <tr>
                <td>Chek in</td>
