...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Prasasti Hotel | Input Data Kamar</title>
	...
	<body>
        ...
        <div id="header">
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                      <form id="form1" method="post" action="input_kamar.php">
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <table width="514" border="0">
                          <tr>
                            <td width="176"><span class="style1">Id kamar</span></td>
                            <td width="9"><span class="style1">:</span></td>
<td width="315"><span class="style1">
  <label>
                              <input name="id_kamar" type="text" class="alpha" id="id_kamar" />
                </label>
</span></td>
                          </tr>
                          <tr>
                            <td><span class="style1">Tipe Kamar</span></td>
                            <td><span class="style1">:</span></td>
                            <td><input name="tipe_kamar" type="text" id="tipe_kamar" /></td>
                          </tr>
                          <tr>
                            <td><span class="style1">Harga Kamar</span></td>
                            <td><span class="style1">:</span></td>
                          ...
                          <tr>
                            <td><span class="style1">Jumlah Kosong</span></td>
                            <td><span class="style1">:</span></td>
                          ...
                          <tr>
                            ...
                            <td><span class="style1">:</span></td>
                            <td><input name="sisa" type="text" id="sisa" size="5" /></td>
                          </tr>
                          <tr>
                            <td><span class="style1">Keterangan</span></td>
                            <td><span class="style1">:</span></td>
                            <td><span class="style1">
                              <label>
                          ...
                          <tr>
                            <td><span class="style1">No kamar</span></td>
                            <td><span class="style1">:</span></td>
                            <td><span class="style1">
                              <label>
                              <input name="no_kamar" type="text" id="no_kamar" size="30" />
                              </label>
                            </span></td>
                          </tr>
