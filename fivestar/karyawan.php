...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Prasasti Hotel | Input Data Karyawan</title>
	...
	<body>
        ...
        <div id="header">
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                      <form id="form1" method="post" action="input_karyawan.php">
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <table width="514" border="0">
                          <tr>
                            <td><span class="style1">Id karyawan</span></td>
                            <td><span class="style1">:</span></td>
                            <td><span class="style1">
                              <label>
                                <input name="id_petugas" type="text" class="alpha" id="id_petugas" />
                            </label>
                            </span></td>
                          </tr>
                          <tr>
                            ...
                            <td><span class="style1">:</span></td>
                            <td><input name="nama_pet" type="text" id="nama_pet" /></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td><span class="style1">Tanggal Lahir</span></td>
                            <td><span class="style1">:</span></td>
                            <td><input name="tgl_lahir" type="text" id="tgl_lahir" /></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td><span class="style1">Telepon</span></td>
                            <td><span class="style1">:</span></td>
                            <td><input name="telp" type="text" id="telp" /></td>
                          </tr>
                          <tr>
                            <td><span class="style1">Bagian</span></td>
                            <td><span class="style1">:</span></td>
                            <td><span class="style1">
                              <label>
                          ...
                          <tr>
                            <td colspan="3"><input type="submit" name="button" id="button" value="simpan" />
                                <label></label></td>
                          </tr>
                        </table>
                      </form>
